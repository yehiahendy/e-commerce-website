...
var EventEmitter = (function () {
    ...
    EventEmitter.prototype.getListeners = function (eventName) {
        ...
        if (listeners !== undefined) {
            assert_1.assert(listeners.length > 0, "No listener for event '" + eventName + "'");
            return listeners;
        }
        return [];
    };
    EventEmitter.prototype.addListener = function (eventName, listener) {
        ...
        var listeners = this.listeners.get(eventName);
        assert_1.assert(!listeners.includes(listener), "Listener already added for event '" + eventName + "'");
        listeners.push(listener);
    };
    EventEmitter.prototype.removeListener = function (eventName, listener) {
        var listeners = this.listeners.get(eventName);
        assert_1.assert(listeners !== undefined, "Unknown event '" + eventName + "'");
        var index = listeners.lastIndexOf(listener);
        assert_1.assert(index > -1, "Listener not found for event '" + eventName + "'");
